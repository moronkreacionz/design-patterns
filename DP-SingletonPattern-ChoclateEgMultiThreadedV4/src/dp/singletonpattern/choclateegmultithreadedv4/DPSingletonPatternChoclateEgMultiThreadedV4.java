 ...
 */
public class DPSingletonPatternChoclateEgMultiThreadedV4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Different from V3, since this one does \n"
                + " Early instantiation and not lazy instantiation \n"
                + "V4 is performing object instantiation using static initializer \n"
                + ".. make note of above.\n\n\n"
                + ".. \n"
                + ".. \n"
